...
*   **Frontend UI:** Vanilla HTML/CSS/JS con un concepto visual de diseño "Editorial Minimalista" enfocado a lectura fina (basado en fuentes *Instrument Serif* y paleta OKLCH en rojo y papel). Soporte nativo para lectura asíncrona por **Chunks (Streaming)** para simular la escritura humana en tiempo real.
